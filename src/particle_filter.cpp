...
void ParticleFilter::resample() {
  ...
  //for (int i = 0; i < particles.size(); i++){
  //  std::cout << "updated: " << i << "  theta:"<< particles[i].theta << "  weight:" << particles[i].weight 
  //  << "  x:"<< particles[i].x << "  y:" << particles[i].y <<endl ;
  //}
  //std::cout << "--------------------------" << endl;

  //for (int i = 0; i < particles.size(); i++){
  //  cout << "resampled: " << i << "  theta:"<< new_particles[i].theta << "  weight:" << new_particles[i].weight 
  //  << "  x:"<< new_particles[i].x << "  y:" << new_particles[i].y << endl;
  //}
  //std::cout << "--------------------------" << endl;
